...
void ppixel(int x, int y) {
    ...
    unsigned short offset = y * 80 + (x >> 3);
    ...
    unsigned char val = fbp[offset];
    val =val  | mask;  // apagar pixel (ficar preto)
    fbp[offset] = val;
}
void cls(){
    int a=0;
